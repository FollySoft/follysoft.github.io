...
let blogName = "jwest's blog";
let authorName = "jwest";
let authorLink = "jwest.github.io"; // Enter your website, social media, etc. Some way for people to tell you they like your blog! (Leaving it empty is okay too)
...
//[ "posts/2020-11-10-My-Second-Post-Example.html" ],
  ...
  [ "posts/2023-05-17-Pespectives-Game-Devlog-1.html" ],
  [ "posts/2023-06-09-Pespectives-Game-Devlog-2.html" ]
];
...
let footerHTML = "<hr><p></a>This blog is built with <a href='https://zonelets.net/'>Zonelets!</a></p>";
...
if ( postsArray.length > recentPostsCutoff ) {
  recentPostListHTML += '<li class="moreposts"><a href=' + relativePath + '/archive.html target="_blank">\u00BB more posts</a></li></ul>';
} else {
...
if ( postsArray.length < 2 ) {
  nextprevHTML = '<a href="' + relativePath + '/archive.html">Archive</a>';
} else if ( currentIndex === 0 ) {
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = '<a href="' + relativePath + '/archive.html">Archive</a> | <a href="'+ relativePath + '/' + prevlink +'">Previous Post \u00BB</a>';
} else if ( currentIndex === postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  nextprevHTML = '<a href="' + relativePath + '/' + nextlink +'">\u00AB Previous Post</a> | <a href="' + relativePath + '/archive.html">Archive</a>';
} else if ( 0 < currentIndex && currentIndex < postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = '<a href="' + relativePath + '/'+ nextlink +'">\u00AB Previous Post</a> | <a href="' + relativePath + '/archive.html">Archive</a> | <a href="' + relativePath + '/'+ prevlink +'">Next Post \u00BB</a>';
}
